...
const Hero = ({ isSticky }) => {
  return (
    <div className={`h-[100vh] bg-[#121D50] ${isSticky ? "" : "relative"}`}>
      <NavbarB />
      <div className="flex flex-row py-10 px-32 relative gap-4">
        <Image link={Truck} className="top-20 right-0 absolute h-full z-10" />
        <div className="w-full mt-40 text-left">
          <div className="">
            ...
            <p className="text-white">
              ...
              praesentium porro dolorem, repudiandae nisi laborum unde cumque,
              magnam, iure eius amet aperiam excepturi architecto. Saepe?
            </p>
          </div>
          <p className="py-4"></p>
